...
final class AdminSettingsController
{
    ...
    public function get(\WP_REST_Request $req): \WP_REST_Response
    {
        ...
        return new \WP_REST_Response([
            ...
            'logo_url'                       => $s->logoUrl(),
            'show_booking_heading'           => $s->showBookingHeading(),
            'step_label_select_day'          => $s->stepLabelSelectDay(),
            'step_label_select_slot'         => $s->stepLabelSelectSlot(),
            'step_label_select_service'      => $s->stepLabelSelectService(),
            'step_label_fill_details'        => $s->stepLabelFillDetails(),
            'step_label_payment'             => $s->stepLabelPayment(),
    ...
    public function patch(\WP_REST_Request $req): \WP_REST_Response|\WP_Error
    {
        ...
        $allowed = [
            ...
            'show_booking_heading'           => 'boolval',
            'step_label_select_day'          => 'sanitize_text_field',
            'step_label_select_slot'         => 'sanitize_text_field',
            'step_label_select_service'      => 'sanitize_text_field',
            'step_label_fill_details'        => 'sanitize_text_field',
            'step_label_payment'             => 'sanitize_text_field',
